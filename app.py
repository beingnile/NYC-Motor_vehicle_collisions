...
A Streamlit dashboard that can be used to analyze motor vehicle collisions in New York City
"""
...
st.markdown("This is a Streamlit dashboard that can be used to analyse motor vehicle collisions in New York City")
...
st.markdown("Move the slider to pick the number of people to check.  \
            The map shows the spots where most people are \
            injured")
